...
class _AddPageState extends State<AddPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    Connectivity().onConnectivityChanged.listen((status) {
      setState(() {
        hasInternet = !status.contains(ConnectivityResult.none);
      });
    });
  }
...
//         const SnackBar(content: Text("Sana format xato")),
//       );
//       return;
//     }
//
...
//
//     /// 🔔 Local notification joyi
//     final now = DateTime.now();
//     final oneDayBefore = parsedDate.subtract(const Duration(days: 1));
//
//     /// To‘y ertasi uchun xabar
//     await NotificationService.scheduleNotification(
//       id: 1,
//       title: "Ertaga to‘y bo‘ladi 🎉",
//       body: "${wedding.location} to‘yi ertaga bo‘lib o‘tadi.",
//       dateTime: oneDayBefore,
//     );
//
// // To‘y kuni uchun xabar
//     await NotificationService.scheduleNotification(
//       id: 2,
//       title: "Bugun to‘y kuni 💍",
//       body: "${wedding.location} to‘yi bugun!",
//       dateTime: parsedDate,
//     );
//
// // Darhol saqlanganda ham xabar berish
//     await NotificationService.showInstantNotification(
//       id: 3,
//       title: "✅ To‘y qo‘shildi",
//       body: "${wedding.location} to‘yi jadvalga qo‘shildi.",
//     );
//
//     if (!mounted) return;
//
  ...
  Future<void> _saveWedding() async {
    ...
    final wedding = Wedding(
      ...
      weddingType: selectedType == "Boshqa"
          ? _customTypeController.text.trim()
          : (selectedType ?? ""),
      starterType: selectedStarter == "Boshqa"
          ? _customStarterController.text.trim()
          : (selectedStarter ?? ""),
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildDropdown(
                        ...
                        validator: (v) => v == null ? "Boshlovchini tanlang" : null,
                      ),
                      const SizedBox(height: 14),
                      if (selectedStarter == "Boshqa")
                        _buildTextField(
                          controller: _customStarterController,
                          label: "Boshqa boshlovchi nomi",
                        ),
